                        ...
                        <td>
                            <ww:property value="/notificationSchemes(./name)">
                                <ul>
                                    ...
                                    <ww:else>
                                        <ww:iterator value=".">
                                            <li><a href="<%= request.getContextPath() %>/secure/admin/EditNotifications!default.jspa?schemeId=<ww:property value="./id"/>"><ww:property value="./name" /></a></li>
                                        </ww:iterator>
                                    </ww:else>
                                </ul>
                            </ww:property>
                        ...
                        <td>
                            <ww:property value="/issueSecuritySchemes(./name)">
                                <ul>
                                    ...
                                    <ww:else>
                                        <ww:iterator value=".">
                                            <li><a href="<%= request.getContextPath() %>/secure/admin/EditIssueSecurities!default.jspa?schemeId=<ww:property value="./id"/>"><ww:property value="./name" /></a></li>
                                        </ww:iterator>
                                    </ww:else>
                                </ul>
                            </ww:property>
