<%@ taglib uri="webwork" prefix="ww" %><%@ page import="webwork.util.ValueStack" %><%@ page import="com.atlassian.jira.component.ComponentAccessor" %><%
    response.setContentType("text/xml;charset=" + ComponentAccessor.getApplicationProperties().getEncoding());
