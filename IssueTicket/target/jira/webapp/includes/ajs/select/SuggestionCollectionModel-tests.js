    ...
    function(
        ...
        module('SuggestionCollectionModel', {
            setup: function() {
                ...
                var $fixtureContainer = jQuery('#qunit-fixture');
                this.$element = jQuery('<input type="text" id="modelValue"/>').appendTo($fixtureContainer);
                this.$options = jQuery('<div id="modelValue-options"/>').attr('data-suggestions', JSON.stringify(this.descriptors))
                        .appendTo($fixtureContainer);
                this.model = new SuggestionCollectionModel({element:this.$element});
            },
            teardown: function() {
                this.$options.remove();
                this.$element.remove();
