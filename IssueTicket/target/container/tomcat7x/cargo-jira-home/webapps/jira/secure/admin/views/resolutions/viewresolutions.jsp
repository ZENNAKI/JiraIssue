            ...
            <tr>
                ...
                <td>
                    <ww:if test="@status/first != true">
                        <a href="<ww:url page="ResolutionUp.jspa"><ww:param name="'up'" value="string('id')" /></ww:url>"><span class="icon-default aui-icon aui-icon-small aui-iconfont-up"><ww:text name="'admin.issuesettings.resolutions.move.up'"/></span></a>
                    </ww:if>
                    <ww:if test="@status/last != true">
                        <a href="<ww:url page="ResolutionDown.jspa"><ww:param name="'down'" value="string('id')" /></ww:url>"><span class="icon-default aui-icon aui-icon-small aui-iconfont-down"><ww:text name="'admin.issuesettings.resolutions.move.down'"/></span></a>
                    </ww:if>
                </td>
                <td>
