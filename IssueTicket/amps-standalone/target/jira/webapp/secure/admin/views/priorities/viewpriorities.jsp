...
<table class="aui aui-table-rowhover">
    ...
    <ww:iterator value="/constantsManager/priorities" status="'status'">
        <tr>
            ...
            <td>
                <ww:if test="@status/first != true"><a href="<ww:url page="PriorityUp.jspa"><ww:param name="'up'" value="string('id')" /></ww:url>"><span class="icon-default aui-icon aui-icon-small aui-iconfont-up"><ww:text name="'admin.issuesettings.priorities.move.priority.up'"/></span></a></ww:if>
                <ww:if test="@status/last != true"><a href="<ww:url page="PriorityDown.jspa"><ww:param name="'down'" value="string('id')" /></ww:url>"><span class="icon-default aui-icon aui-icon-small aui-iconfont-down"><ww:text name="'admin.issuesettings.priorities.move.priority.down'"/></span></a></ww:if>
            </td>
            <td>
