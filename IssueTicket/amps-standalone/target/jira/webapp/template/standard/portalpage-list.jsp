            ...
            <tr id="pp_<ww:property value="./id" />" <ww:if test="@status/first == true">class="first-row"</ww:if><ww:if test="@status/last == true">class="last-row"</ww:if>>
                ...
                <ww:if test="parameters['ordering'] != 'false'">
                    <td class="cell-type-collapsed">
                        <a class="portal_pos_first" id="pos_first_<ww:property value="@status/index" />" href="<ww:url page="ConfigurePortalPages!moveToStart.jspa"><ww:param name="'pageId'" value="./id"/></ww:url>"><span class="icon-default aui-icon aui-icon-small aui-iconfont-arrows-up" title="<ww:text name="'configureportalpages.movepage.first'"/>"></span></a>
                        <a class="portal_pos_up" id="pos_up_<ww:property value="@status/index" />" href="<ww:url page="ConfigurePortalPages!moveUp.jspa"><ww:param name="'pageId'" value="./id"/></ww:url>"><span class="icon-default aui-icon aui-icon-small aui-iconfont-arrow-up" title="<ww:text name="'configureportalpages.movepage.up'"/>"></span></a>
                        <a class="portal_pos_down" id="pos_down_<ww:property value="@status/index" />" href="<ww:url page="ConfigurePortalPages!moveDown.jspa"><ww:param name="'pageId'" value="./id"/></ww:url>"><span class="icon-default aui-icon aui-icon-small aui-iconfont-arrow-down" title="<ww:text name="'configureportalpages.movepage.down'"/>"></span></a>
                        <a class="portal_pos_last" id="pos_last_<ww:property value="@status/index" />" href="<ww:url page="ConfigurePortalPages!moveToEnd.jspa"><ww:param name="'pageId'" value="./id"/></ww:url>"><span class="icon-default aui-icon aui-icon-small aui-iconfont-arrows-down" title="<ww:text name="'configureportalpages.movepage.last'"/>"></span></a>
                    </td>
                </ww:if>
