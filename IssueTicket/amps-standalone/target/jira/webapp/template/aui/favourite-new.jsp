...
<div id="fav_div_<ww:property value="parameters['fieldId']"/>">
    <a id="fav_a_<ww:property value="parameters['fieldId']"/>"
            class="fav-link aui-icon aui-icon-small aui-iconfont-star enabled" title="<ww:text name="'common.favourites.enabled.' +  parameters['entityType']"/>" href="#"><span><ww:text name="'common.favourites.enabled.' +  parameters['entityType']"/></span></a>
</div>
