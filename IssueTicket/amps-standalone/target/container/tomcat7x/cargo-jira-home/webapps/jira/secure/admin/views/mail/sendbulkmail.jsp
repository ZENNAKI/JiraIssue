...
<ww:if test="/hasMailServer == true">
    <page:applyDecorator name="jiraform">
        ...
        <ww:component template="textlabel.jsp" label="text('admin.email.from')" value="mailServerAddress" />
        <ui:component label="'To'" name="'sendToRoles'" value="'sendToRoles'" template="radiotruefalse.jsp">
            ...
            <ui:param name="'fieldBody'">
                <table id="rolesTable" class="related-tables" <ww:if test="sendToRoles == false">style="display: none;"</ww:if>>
                    <tr>
                        <ui:select label="text('admin.email.send.to.projects')" name="'projects'" list="allProjects" listKey="'id()'" listValue="'name()'" template="selectmultiple.jsp" theme="'single'">
