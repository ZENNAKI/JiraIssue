...
<tr>
    ...
    <td class="fieldValueArea">        
        <ww:property value="parameters['shareTypeList']">
                        ...
                        <ww:iterator value="." status="'typeStatus'">
                            <span id="share_<ww:property value="./shareType"/>" <ww:if test="@typeStatus/first == false">style="display:none"</ww:if>>
                                ...
                                <ww:if test="./addButtonNeeded == true">
                                    <span class="addShare" id="share_add_<ww:property value="./shareType"/>"><span class="aui-icon aui-icon-small aui-iconfont-add"></span>&nbsp;<ww:text name="'common.sharing.add.share'"/></span>
                                </ww:if>
                            </span>
                        </ww:iterator>
            ...
            <span id="share_trash" class="aui-icon aui-icon-small aui-iconfont-delete shareTrash" style="display:none;"><ww:text name="'common.sharing.delete.share'"/></span>
            <span id="share_icon" class="aui-icon aui-icon-small aui-iconfont-admin-roles shareIcon" style="display:none;"><ww:text name="'common.sharing.share'"/></span>
